...
:----------- | :-----------: | :-----------: 
[`ft_isalpha`](Libft/ft_isalpha.c)	| [`ft_split`](Libft/ft_split.c)			| [`ft_lstnew`](Libft/ft_lstnew.c)
[`ft_isdigit`](Libft/ft_isdigit.c)	| [`ft_substr`](Libft/ft_substr.c)		| [`ft_lstadd_back`](Libft/ft_lstadd_back.c)
[`ft_isalnum`](Libft/ft_isalnum.c)	| [`ft_strtrim`](Libft/ft_strtrim.c)		| [`ft_lstadd_front`](Libft/ft_lstadd_front.c)
[`ft_isascii`](Libft/ft_isascii.c)	| [`ft_strjoin`](Libft/ft_strjoin.c)		| [`ft_lstsize`](Libft/ft_lstsize.c)
[`ft_isprint`](Libft/ft_isprint.c)	| [`ft_strmapi`](Libft/ft_strmapi.c)		| [`ft_lstlast`](Libft/ft_lstlast.c)
[`ft_strlen`](Libft/ft_strlen.c)		| [`ft_itoa`](Libft/ft_itoa.c)			| [`ft_lstdelone`](Libft/ft_lstdelone.c)
...
[`ft_memcpy`](Libft/ft_memcpy.c)		| [`ft_putnbr_fd`](Libft/ft_putnbr_fd.c)		| [`ft_lstmap`](Libft/ft_lstmap.c)
[`ft_memmove`](Libft/ft_memmove.c)	| [`ft_putstr_fd`](Libft/ft_putstr_fd.c)	
[`ft_strlcpy`](Libft/ft_strlcpy.c)	| [`ft_putendl_fd`](Libft/ft_putendl_fd.c)
